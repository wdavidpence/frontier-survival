...
test('bug sprint: all visible version surfaces agree', () => {
  ...
  assert.ok(html.includes('v1.12.19'), 'HTML must expose v1.12.19');
...
test('v1.12.19: New World is immediate and randomized', () => {
...
test('v1.12.19: ocean island generation is wetter and mirrored', () => {
...
test('v1.12.19: setup popup and touch overlay are configured for two-controller TV mode', () => {
  const html = fsText('index.html');
