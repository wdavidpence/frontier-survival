...
- Latest verified public release: **v1.26.8** (`1a3fee0`, tag `v1.26.8`). It starts fresh worlds at the authored Cane Garden Bay tropical landing, expands the Tortola body to a 120×44-cell authored envelope, and retains the v1.26.5 shelter/workbench loop.
