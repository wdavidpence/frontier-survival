...
- Local fixed-seed production path:
  ...
  - opacity `0.0512` at the initial pulse sample;
...
- Visual correction evidence:
  ...
  - final waterline/anchor correction produces a small pale-green ring distinct from the larger white/amber lantern ring in the frozen proof crop;
