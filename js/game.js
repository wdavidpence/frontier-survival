...
import { World, WORLD_HEIGHT, SEA_LEVEL } from './world.js?v=448';
...
import { iconDataUriForItem } from './item-icons.js?v=22';
...
import { createBlockAtlas } from './atlas.js?v=303';
...
export class Game {
  ...
  _dismountBoat() {
    ...
    const landfall = landfallDistance <= 25;
