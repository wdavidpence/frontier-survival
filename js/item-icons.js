...
function shapeForItemVariant(itemId, name, p) {
  const text = normalizedParts(itemId, name);
  if (/(tied fish bait)/.test(text)) {
    return `<g filter="url(#shadow)" data-item-variant="tied-fish-bait"><path d="M16 24h32v25H16z" fill="#9a623e" stroke="${p.deep}" stroke-width="1.5"/><path d="M16 24c5-6 27-6 32 0" fill="#c9874c" stroke="${p.deep}" stroke-width="1.4"/><path d="M20 29h24M20 44h24" stroke="#efbd72" stroke-width="1.4" stroke-linecap="round"/><path d="M25 36c4-6 10-6 14 0-4 4-10 4-14 0z" fill="#d9e3df" stroke="#557b79" stroke-width="1.1"/><circle cx="29" cy="34" r="1.2" fill="#f07c68"/><circle cx="35" cy="38" r="1.2" fill="#f07c68"/><path d="M24 21c4-4 12-4 16 0M27 20v-4M37 20v-4" fill="none" stroke="#f4dc98" stroke-width="1.4" stroke-linecap="round"/><path d="M21 49h22" stroke="#5f3d2e" stroke-width="1.4" stroke-linecap="round"/></g>`;
  }
  ...
  if (/(striped reef fish|reef-striped fish|lagoon fish)/.test(text)) {
    return `<g filter="url(#shadow)" data-item-variant="striped-reef-fish"><path d="M11 34c8-13 23-16 38-7l9-5-3 12 3 11-9-6c-15 8-30 6-38 0z" fill="#21a6b8" stroke="${p.deep}" stroke-width="1.5"/><path d="M18 33h34" stroke="#ffe06d" stroke-width="3" stroke-linecap="round"/><path d="M24 25v18M31 23v20M38 25v18M45 29v11" stroke="#f15f85" stroke-width="2" opacity=".95"/><path d="M21 28c5-5 12-6 20-4" fill="none" stroke="#b6f3e4" stroke-width="1.5" stroke-linecap="round"/><circle cx="19" cy="31" r="2" fill="#fff7d6" stroke="${p.deep}" stroke-width=".8"/><path d="M46 27l7 7-7 7" fill="none" stroke="#fff0a4" stroke-width="1.5"/><circle cx="28" cy="16" r="1.4" fill="#9fe6ee"/><circle cx="38" cy="13" r="1.1" fill="#9fe6ee"/></g>`;
  }
  if (/(dried tropical fish|smoked tropical fish|jerked fish)/.test(text)) {
    return `<g filter="url(#shadow)" data-item-variant="dried-tropical-fish"><path d="M11 34c8-12 23-15 38-7l9-5-3 12 3 11-9-6c-15 8-30 6-38 0z" fill="#b86b45" stroke="${p.deep}" stroke-width="1.5"/><path d="M18 33h34" stroke="#f4c56e" stroke-width="3" stroke-linecap="round"/><path d="M24 25v18M32 23v20M40 26v15" stroke="#704536" stroke-width="2" opacity=".95"/><path d="M20 29c6-4 13-5 20-3" fill="none" stroke="#f7e1a1" stroke-width="1.5" stroke-linecap="round"/><circle cx="19" cy="31" r="2" fill="#fff4c5" stroke="${p.deep}" stroke-width=".8"/><path d="M46 27l7 7-7 7" fill="none" stroke="#ffd986" stroke-width="1.5"/><path d="M27 18h10M25 21h14" stroke="#8bd8ef" stroke-width="1.2" stroke-linecap="round"/></g>`;
  }
  ...
  if (/(reef caught fish|reef fish|coral fish)/.test(text)) {
    return `<g filter="url(#shadow)" data-item-variant="reef-caught-fish"><path d="M11 34c8-13 23-16 38-7l9-5-3 12 3 11-9-6c-15 8-30 6-38 0z" fill="#2e9fb5" stroke="${p.deep}" stroke-width="1.5"/><path d="M18 33h34" stroke="#ffd45e" stroke-width="3" stroke-linecap="round"/><path d="M25 25v18M33 23v20M41 26v15" stroke="#f06b83" stroke-width="2" opacity=".95"/><path d="M21 28c5-5 12-6 19-4" fill="none" stroke="#a8f0e5" stroke-width="1.6" stroke-linecap="round"/><circle cx="19" cy="31" r="2" fill="#fff7d6" stroke="${p.deep}" stroke-width=".8"/><path d="M46 27l7 7-7 7" fill="none" stroke="#fff0a4" stroke-width="1.5"/><circle cx="29" cy="17" r="1.6" fill="#9fe6ee"/><circle cx="38" cy="14" r="1.2" fill="#9fe6ee"/></g>`;
  }
  ...
  if (/(weathered coconut|salt coconut|aged coconut)/.test(text)) {
    return `<g filter="url(#shadow)" data-item-variant="weathered-coconut"><path d="M32 17c-10-7-21 1-21 13 0 13 9 23 21 23s21-10 21-23c0-12-11-20-21-13z" fill="#5f6d3d" stroke="#35472f" stroke-width="1.5"/><path d="M32 17c0-5 4-9 9-10" fill="none" stroke="#4b5a34" stroke-width="2.5" stroke-linecap="round"/><path d="M38 10c5-4 9-3 12 0-5 4-9 4-12 0z" fill="#607d46" stroke="#304b32" stroke-width="1"/><path d="M19 27c4-5 9-6 15-4" fill="none" stroke="#a7bb6a" stroke-width="1.8" stroke-linecap="round"/><path d="M23 37c5 4 13 6 19 1" fill="none" stroke="#3e5134" stroke-width="2" stroke-linecap="round"/><path d="M21 22l4 2M43 29l5 2M25 46l4-2M39 42l5-2" stroke="#c0a06a" stroke-width="1.3" stroke-linecap="round"/><circle cx="29" cy="31" r="1.7" fill="#e6d39b"/><circle cx="36" cy="35" r="1.3" fill="#e6d39b"/></g>`;
  }
  ...
  if (/(lush palm frond|fresh palm frond|palm leaf)/.test(text)) {
    return `<g filter="url(#shadow)" data-item-variant="lush-palm-frond"><path d="M31 52c1-12 3-24 7-34" fill="none" stroke="#355d38" stroke-width="3" stroke-linecap="round"/><path d="M34 27C23 23 14 16 11 8c12 1 20 7 24 16zM36 24c2-11 8-19 18-23-1 12-7 20-18 23zM37 31c10-5 19-5 27-1-8 8-17 9-27 5zM31 35c-10-1-18 2-24 9 10 3 18 0 24-6z" fill="#3f9d55" stroke="#245c3a" stroke-width="1.25"/><path d="M34 28 17 12M37 25 50 8M38 34 57 31M31 37 13 43" stroke="#b7ec8c" stroke-width="1.3" stroke-linecap="round"/><path d="M25 21c5 1 9 3 13 7M39 18c4-3 8-6 12-8" stroke="#e5f4ab" stroke-width="1.1" stroke-linecap="round" opacity=".85"/><circle cx="39" cy="18" r="1.4" fill="#fff1a4"/></g>`;
  }
  ...
  if (/(trail boots|shore boots|deck boots)/.test(text)) {
    return `<g filter="url(#shadow)" data-item-variant="trail-boots"><path d="M15 13h15v25l7 5c4 3 3 9-2 10H13c-5 0-7-5-4-9l6-7z" fill="#9a623c" stroke="${p.deep}" stroke-width="1.5"/><path d="M34 13h15v25l7 5c4 3 3 9-2 10H32c-5 0-7-5-4-9l6-7z" fill="#70452f" stroke="${p.deep}" stroke-width="1.5"/><path d="M16 22h13M35 22h13" stroke="#f0c27c" stroke-width="2" stroke-linecap="round"/><path d="M12 46h20M34 46h20" stroke="#d4965d" stroke-width="1.6" stroke-linecap="round"/><path d="M17 32h11M36 32h11M18 40h10M37 40h10" stroke="#4d8e91" stroke-width="1.5" stroke-linecap="round"/><path d="M14 51h16M34 51h16" stroke="#263c49" stroke-width="2" stroke-linecap="round"/></g>`;
  }
  ...
  if (/(packed ration|sealed ration|trail ration)/.test(text)) {
    return `<g filter="url(#shadow)" data-item-variant="packed-ration"><path d="M13 25h38c-2 15-9 24-19 24S15 40 13 25z" fill="#8f5933" stroke="${p.deep}" stroke-width="1.4"/><path d="M17 26h30c-2 10-7 17-15 17S19 36 17 26z" fill="#c67b3f" stroke="#5f3c2d" stroke-width="1.2"/><ellipse cx="32" cy="25" rx="19" ry="7" fill="#e6ad5b" stroke="${p.deep}" stroke-width="1.4"/><path d="M20 25h24M22 29h20" stroke="#ffe1a0" stroke-width="1.4" stroke-linecap="round"/><path d="M24 35h16M24 40h16" stroke="#78462f" stroke-width="1.4" stroke-linecap="round"/><rect x="28" y="21" width="8" height="6" rx="1" fill="#eef1d4" stroke="#72805b" stroke-width=".9"/><path d="M23 20c4-2 14-2 18 0" stroke="#8fe8ff" stroke-width="1.2" stroke-linecap="round" opacity=".8"/></g>`;
  }
  ...
  if (/(reef bait|saltwater bait|bait pouch|fish bait)/.test(text)) {
    return `<g filter="url(#shadow)" data-item-variant="reef-bait-pouch"><path d="M16 24h32v25H16z" fill="#b47748" stroke="${p.deep}" stroke-width="1.5"/><path d="M16 24c5-6 27-6 32 0" fill="#d59a5c" stroke="${p.deep}" stroke-width="1.4"/><path d="M20 29h24M20 44h24" stroke="#f2c47b" stroke-width="1.4" stroke-linecap="round"/><path d="M25 36c4-6 10-6 14 0-4 4-10 4-14 0z" fill="#d9e3df" stroke="#557b79" stroke-width="1.1"/><circle cx="29" cy="34" r="1.2" fill="#f07c68"/><circle cx="35" cy="38" r="1.2" fill="#f07c68"/><path d="M27 21c3-4 8-4 11 0" fill="none" stroke="#8bd8ef" stroke-width="1.4" stroke-linecap="round"/><path d="M21 49h22" stroke="#6f442f" stroke-width="1.4" stroke-linecap="round"/></g>`;
  }
  ...
  if (/(loaded compass|tracking compass)/.test(text)) {
    return `<g filter="url(#shadow)" data-item-variant="loaded-compass"><circle cx="32" cy="32" r="20" fill="#d8e2e7" stroke="${p.deep}" stroke-width="1.6"/><circle cx="32" cy="32" r="15" fill="#f5f1d0" stroke="${p.dark}" stroke-width="1.2"/><path d="M39 24 34 35l-11 5 5-11z" fill="#e35f53" stroke="${p.deep}" stroke-width="1.1"/><path d="m25 40 5-11 11-5-5 11z" fill="#5e8fa9" opacity=".9"/><circle cx="32" cy="32" r="2" fill="#fff1a4" stroke="${p.deep}" stroke-width=".8"/><path d="M32 13v4M32 47v4M13 32h4M47 32h4" stroke="${p.glint}" stroke-width="1.4" stroke-linecap="round"/><path d="M20 18c6-5 15-6 23-2" fill="none" stroke="#9dff9a" stroke-width="1.5" stroke-linecap="round"/></g>`;
  }
  ...
  if (/(braced shield|raised shield|guarding shield)/.test(text)) {
    return `<g filter="url(#shadow)" data-item-variant="braced-shield"><path d="M12 16c12 5 28 5 40 0v18c0 13-8 22-20 26-12-4-20-13-20-26z" fill="#8d5d3d" stroke="${p.deep}" stroke-width="1.6"/><path d="M17 20c9 3 19 4 30 0v14c0 9-5 16-15 21-10-5-15-12-15-21z" fill="#5b4032"/><path d="M32 22v27M20 34h24" stroke="#e9b966" stroke-width="2" opacity=".9"/><path d="m32 25 3 7 7 1-5 5 1 7-6-3-6 3 1-7-5-5 7-1z" fill="#d9b463" stroke="#7d5635" stroke-width="1"/><path d="M16 27h6M42 27h6" stroke="#9fe6ee" stroke-width="2" stroke-linecap="round"/><circle cx="21" cy="22" r="1.7" fill="#fff0a5"/></g>`;
  }
  if (/(shield)/.test(text)) {
  ...
  if (/(cast fishing rod|fishing cast|hooked rod)/.test(text)) {
    return `<g filter="url(#shadow)" data-item-variant="cast-fishing-rod"><path d="M16 50 42 12" stroke="${p.deep}" stroke-width="4" stroke-linecap="round"/><path d="M18 49 43 13" stroke="#b87945" stroke-width="2" stroke-linecap="round"/><path d="M42 13c10 5 10 14 5 20l-8 10" fill="none" stroke="#ffe6a3" stroke-width="1.3"/><path d="M39 43c5 3 8 5 12 3" fill="none" stroke="#8bd8ef" stroke-width="1.4"/><path d="M51 46c4 5 1 8-2 9" fill="none" stroke="#f4f5d6" stroke-width="1.2"/><circle cx="18" cy="49" r="4" fill="#d99a55" stroke="${p.deep}" stroke-width="1.2"/><circle cx="51" cy="55" r="2" fill="#9fe6ee"/></g>`;
  }
  ...
  if (/(weathered map|salt-stained map|folded chart)/.test(text)) {
    return `<g filter="url(#shadow)" data-item-variant="weathered-map"><path d="M10 15l14-5 14 5 16-5v39l-16 5-14-5-14 5z" fill="#b78f5b" stroke="${p.deep}" stroke-width="1.5"/><path d="M24 10v39M38 15v39" stroke="#704e3b" stroke-width="1.3"/><path d="M15 27c6-5 11 2 16-3s8 1 16-4" fill="none" stroke="#4b8067" stroke-width="2"/><path d="M18 35l7-2M42 34l10-3" stroke="#f4d49a" stroke-width="1.5" stroke-linecap="round"/><path d="M19 18l7 2M41 20l8-2M17 43l8-2" stroke="#8a684d" stroke-width="1.3" stroke-linecap="round"/><circle cx="44" cy="25" r="2.4" fill="#e16b51" stroke="#7e3f38" stroke-width="1"/></g>`;
  }
  if (/(marked map|charted map|treasure map)/.test(text)) {
    return `<g filter="url(#shadow)" data-item-variant="marked-map"><path d="M10 15l14-5 14 5 16-5v39l-16 5-14-5-14 5z" fill="#e9cf88" stroke="${p.deep}" stroke-width="1.5"/><path d="M24 10v39M38 15v39" stroke="#9f774d" stroke-width="1.3"/><path d="M15 27c6-5 11 2 16-3s8 1 16-4" fill="none" stroke="#5b9b76" stroke-width="2"/><path d="M18 35l7-2M42 34l10-3" stroke="#ffffff" stroke-width="1.7" stroke-linecap="round"/><path d="M39 25 44 18l5 7-5 7z" fill="#e4574f" stroke="#8d3d38" stroke-width="1.1"/><circle cx="44" cy="25" r="2" fill="#ffe79c"/></g>`;
  }
  if (/(^| )map( |$)/.test(text)) {
  ...
  if (/(full water bucket|filled bucket|water-filled bucket)/.test(text)) {
    return `<g filter="url(#shadow)" data-item-variant="full-water-bucket"><path d="M16 23h33l-4 28H20z" fill="#245886" stroke="${p.deep}" stroke-width="1.4"/><path d="M20 25h25l-3 22H23z" fill="#4e9dca"/><path d="M17 22h31v7H17z" fill="#b7eaff" stroke="${p.deep}" stroke-width="1.3"/><path d="M22 23c0-13 22-16 27-2" fill="none" stroke="#2e648a" stroke-width="2.2" stroke-linecap="round"/><path d="M23 35h20M25 41h16" stroke="#d8fbff" stroke-width="2.4" stroke-linecap="round"/><path d="M27 31c3-2 7-2 10 0" stroke="#ffffff" stroke-width="1.2" stroke-linecap="round" opacity=".85"/><path d="M30 28v-3M37 28v-3" stroke="#8fe8ff" stroke-width="1.2" stroke-linecap="round"/></g>`;
  }
