import { Game } from './game.js?v=213';
import { hasSave, clearSaveStorage } from './save.js?v=213';
import { MODES, MODE_ORDER, getMode, difficulty_presets_explain } from './modes.js?v=213';
import {
  writeSettings,
...
console.info('Frontier Survival boot OK · v1.10.12');
