...
import { isSolid, BLOCK } from './blocks.js?v=184';
import { canSprint, moveSpeedMultiplier, fallDamageFromSpeed } from './survival.js?v=184';
import { createStarterInventory, getHotbarStack } from './inventory.js?v=184';
import { emptyEquipment } from './equipment.js?v=184';
import { ITEM } from './items.js?v=184';
