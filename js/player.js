...
import { isSolid, BLOCK } from './blocks.js?v=204';
import { canSprint, moveSpeedMultiplier, fallDamageFromSpeed } from './survival.js?v=204';
import { createStarterInventory, getHotbarStack } from './inventory.js?v=204';
import { emptyEquipment } from './equipment.js?v=204';
import { ITEM } from './items.js?v=204';
