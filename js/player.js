...
import { canSprint, moveSpeedMultiplier, fallDamageFromSpeed } from './survival.js?v=207';
import { createStarterInventory, getHotbarStack } from './inventory.js?v=207';
import { emptyEquipment } from './equipment.js?v=207';
import { ITEM } from './items.js?v=207';
