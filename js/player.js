...
import { canSprint, moveSpeedMultiplier, fallDamageFromSpeed } from './survival.js?v=208';
import { createStarterInventory, getHotbarStack } from './inventory.js?v=208';
import { emptyEquipment } from './equipment.js?v=208';
import { ITEM } from './items.js?v=208';
