...
import { isSolid, BLOCK } from './blocks.js?v=209';
import { canSprint, moveSpeedMultiplier, fallDamageFromSpeed } from './survival.js?v=209';
import { createStarterInventory, getHotbarStack } from './inventory.js?v=209';
import { emptyEquipment } from './equipment.js?v=209';
import { ITEM } from './items.js?v=209';
