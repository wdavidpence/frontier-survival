...
import { isSolid, BLOCK } from './blocks.js?v=183';
import { canSprint, moveSpeedMultiplier, fallDamageFromSpeed } from './survival.js?v=183';
import { createStarterInventory, getHotbarStack } from './inventory.js?v=183';
import { emptyEquipment } from './equipment.js?v=183';
import { ITEM } from './items.js?v=183';
