...
import { isSolid, BLOCK } from './blocks.js?v=186';
import { canSprint, moveSpeedMultiplier, fallDamageFromSpeed } from './survival.js?v=186';
import { createStarterInventory, getHotbarStack } from './inventory.js?v=186';
import { emptyEquipment } from './equipment.js?v=186';
import { ITEM } from './items.js?v=186';
