...
import { BLOCK, BLOCK_PROPS, isSolid, isTransparent, getColor } from './blocks.js?v=206';
import { heightAt, hash2, fbm } from './gen.js?v=206';
import { biomeAt, BIOME } from './biomes.js?v=206';
import { tileForBlock } from './atlas-core.js?v=206';
import { greedyMeshChunk, quadsToArrays } from './mesh-greedy.js?v=206';
...
export class World {
  ...
  _ensureWorkers() {
    ...
    const workerUrl = './js/chunk-worker.js?v=206';
