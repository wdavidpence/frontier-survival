...
import { BLOCK, BLOCK_PROPS, isSolid, isTransparent, getColor } from './blocks.js?v=205';
import { heightAt, hash2, fbm } from './gen.js?v=205';
import { biomeAt, BIOME } from './biomes.js?v=205';
import { tileForBlock } from './atlas-core.js?v=205';
import { greedyMeshChunk, quadsToArrays } from './mesh-greedy.js?v=205';
...
export class World {
  ...
  _ensureWorkers() {
    ...
    const workerUrl = './js/chunk-worker.js?v=205';
