...
export function layoutChicken(spec) {
  ...
  parts.push(part('crest0', w * 0.12, h * 0.22, w * 0.12, 0, crestBaseY + h * 0.04, headZ + headS * 0.02, [0.92, 0.14, 0.10], 'crest'));
  parts.push(part('crest1', w * 0.10, h * 0.18, w * 0.10, 0, crestBaseY + h * 0.01, headZ - headS * 0.14, [0.86, 0.10, 0.08], 'crest'));
  parts.push(part('crest2', w * 0.10, h * 0.18, w * 0.10, 0, crestBaseY + h * 0.01, headZ + headS * 0.18, [0.86, 0.10, 0.08], 'crest'));
  parts.push(part('wattle', w * 0.10, h * 0.18, w * 0.10, 0, headY - headS * 0.42, headZ + headS * 0.32, [0.82, 0.08, 0.06], 'crest'));
  ...
  parts.push(part('tail', w * 0.22, h * 0.38, w * 0.08, 0, bodyY + bodyH * 0.28, -l * 0.50, dark, 'tail'));
  parts.push(part('tailFanL', w * 0.10, h * 0.30, w * 0.08, -w * 0.12, bodyY + bodyH * 0.24, -l * 0.48, warm, 'tail'));
  parts.push(part('tailFanR', w * 0.10, h * 0.30, w * 0.08, w * 0.12, bodyY + bodyH * 0.24, -l * 0.48, warm, 'tail'));
