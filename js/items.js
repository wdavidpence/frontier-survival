...
export const ITEM_PROPS = {
  [ITEM.STICK]: { name: 'Stick', color: [0.55, 0.4, 0.22], maxStack: 64 },
  [ITEM.RATION]: { name: 'Dried Ration', color: [0.72, 0.55, 0.3], edible: 28, maxStack: 16 },
  [ITEM.WOOD_PICK]: { name: 'Wood Pick', color: [0.65, 0.5, 0.28], tool: 'pick', mineMult: 2.2, maxStack: 1 },
  [ITEM.WOOD_AXE]: { name: 'Wood Axe', color: [0.6, 0.42, 0.2], tool: 'axe', mineMult: 2.4, maxStack: 1 },
  [ITEM.STONE_PICK]: { name: 'Stone Pick', color: [0.55, 0.55, 0.58], tool: 'pick', mineMult: 3.4, maxStack: 1 },
